...
from src.training import get_models, train, save_model
...
def main():
    ...
    for model_name, classifier in models.items():
        ...
        try:
            ...
            trained_pipeline = train(full_pipeline, X_train, y_train)
            training_time = time.time() - start_time

            best_pipeline = trained_pipeline
            print(f"Model trained with fixed parameters")
            ...
            metrics["params"] = str(best_pipeline.named_steps['classifier'].get_params())
